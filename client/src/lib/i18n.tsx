...
const translations = {
  ...
  ar: {
    ...
    "discover.locationRequired": "يجب تفعيل الموقع لعرض المقاهي القريبة.",
    "discover.enableLocation": "تفعيل الموقع",
    "discover.locationDenied": "يجب تفعيل الموقع لعرض المقاهي القريبة.",
    "discover.locationError": "يجب تفعيل الموقع لعرض المقاهي القريبة.",
    "discover.locationEnabled": "تم تفعيل الموقع. عرض المقاهي القريبة.",
